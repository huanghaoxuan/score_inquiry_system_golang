...
type StudentInformation struct {
	...
	ProfesionalOld string    `form:"profesionalOld" gorm:"column:department_old" ？json:"departmentOld"`    //原所在专业
	...
	ProfesionalNew string    `form:"profesionalNew" gorm:"column:profesional_new" json:"profesionalNew"`   //现所在专业
